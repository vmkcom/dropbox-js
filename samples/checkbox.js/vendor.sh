...
curl --fail https://cdnjs.cloudflare.com/ajax/libs/less.js/1.4.1/less.min.js \
    > public/lib/less.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.10.1/dropbox.min.js \
    > public/lib/dropbox.min.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.10.1/dropbox.js \
    > public/lib/dropbox.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.10.1/dropbox.min.map \
