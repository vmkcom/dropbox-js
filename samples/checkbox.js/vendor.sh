...
curl --fail https://cdnjs.cloudflare.com/ajax/libs/less.js/1.3.3/less.min.js \
    > public/lib/less.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.9.0/dropbox.min.js \
    > public/lib/dropbox.min.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.9.0/dropbox.js \
    > public/lib/dropbox.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/0.9.0/dropbox.min.map \
